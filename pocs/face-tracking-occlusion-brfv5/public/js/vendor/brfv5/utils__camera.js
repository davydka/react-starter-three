...
export const _default480p = { width: 640, height: 480, frameRate: 60, facingMode: CameraFacingMode.USER }
...
export const startCamera = (video, videoConstraints) => {
  ...
  // console.log(logName + 'startCamera:', _videoConstraints)
...
export const stopCamera = (video, pause = true, silent = false) => {
  if (!silent) {
    console.log(logName + 'stopCamera')
  }
  ...
  if (mediaStream) {
    ...
    console.warn(logName + 'stopCamera: No mediaStream attached to video.')
  }
...
export const toggleCameraFacingMode = (video) => {
  console.log(logName + 'toggleCameraFacingMode')
  ...
  console.log(logName + 'toggleCameraFacingMode: to ' + newMode)
